...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter ID to be Deleted<p>
<form action="Delete" method="post" name="form" onsubmit=" return vald();">
<table>
<tr><td>ID:</td><td><input type="text" name="id"></td><td id="id" style="color:red;"></td></tr>
<tr><td></td><td><input type="Submit" value="Submit" onclick="alert('Confrim to delete Id');"></td></tr>
</table>
</form>
</right>
</div>
